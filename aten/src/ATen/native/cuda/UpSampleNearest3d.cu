...
static void upsample_nearest3d_out_cuda_template(
  ...
  AT_DISPATCH_ALL_TYPES_AND(ScalarType::Half, input.scalar_type(), "upsample_nearest3d_out_frame", [&] {
...
static void upsample_nearest3d_backward_out_cuda_template(
  ...
  cudaStream_t stream = at::cuda::getCurrentCUDAStream();
  AT_DISPATCH_ALL_TYPES_AND(ScalarType::Half, grad_output.scalar_type(), "upsample_nearest3d_backward_out_frame", [&] {
        using accscalar_t = at::acc_type<scalar_t, true>;
