...
void upsample_nearest1d_kernel_impl(
  ...
  AT_DISPATCH_ALL_TYPES_AND(at::ScalarType::Half, input.scalar_type(), "upsample_nearest1d", [&] {
...
void upsample_nearest2d_kernel_impl(
    ...
    c10::optional<double> scales_w) {
  AT_DISPATCH_ALL_TYPES_AND(at::ScalarType::Half, input.scalar_type(), "upsample_nearest2d", [&] {
...
void upsample_nearest3d_kernel_impl(
    ...
    c10::optional<double> scales_h,
    c10::optional<double> scales_w) {
  AT_DISPATCH_ALL_TYPES_AND(at::ScalarType::Half, input.scalar_type(), "upsample_nearest3d", [&] {
...
void upsample_nearest1d_backward_kernel_impl(
    ...
    c10::optional<double> scales_w) {
  AT_DISPATCH_ALL_TYPES_AND(at::ScalarType::Half, grad_output.scalar_type(), "upsample_nearest1d_backward", [&] {
...
void upsample_nearest2d_backward_kernel_impl(
    ...
    c10::optional<double> scales_h,
    c10::optional<double> scales_w) {
  AT_DISPATCH_ALL_TYPES_AND(at::ScalarType::Half, grad_output.scalar_type(), "upsample_nearest2d_backward", [&] {
...
void upsample_nearest3d_backward_kernel_impl(
    ...
    c10::optional<double> scales_h,
    c10::optional<double> scales_w) {
  AT_DISPATCH_ALL_TYPES_AND(at::ScalarType::Half, grad_output.scalar_type(), "upsample_nearest3d_backward", [&] {
